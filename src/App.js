...
import AvisoEnvioFormClient from './views/avisoenvioformcliente.jsx'
    ...
    <>
      ...
      <NavBar />
        <Switch>
          ...
          <Route exact path="/profile/fichaingreso" component={FormIngresoClient} />
          <Route exact path="/profile/envioficha" component={AvisoEnvioFormClient} />
